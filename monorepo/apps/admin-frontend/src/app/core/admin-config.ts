...
export interface AdminConfig {
  /** admin-backend base, e.g. https://admin.daybook.cloud/api (admin routes live under `${adminBackendUrl}/admin`). */
...
export const DEFAULT_ADMIN_CONFIG: AdminConfig = {
  ...
  authLoginUrl: "http://localhost:4200/login",
};
